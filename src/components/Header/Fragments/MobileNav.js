        ...
        <FocusLock disabled={!show} returnFocus>
          ...
          >
            <Box pt="5" pb="6" px="5">
              ...
              >
                <MobileNavLink icon={HiCloudDownload}>Product</MobileNavLink>
                <MobileNavLink icon={HiCurrencyDollar}>Pricing</MobileNavLink>
                <MobileNavLink icon={HiBookOpen}>Resources</MobileNavLink>
                <MobileNavLink icon={HiQuestionMarkCircle}>Help</MobileNavLink>
              </SimpleGrid>
